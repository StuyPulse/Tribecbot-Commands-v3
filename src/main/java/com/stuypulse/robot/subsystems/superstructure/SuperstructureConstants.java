    ...
    public interface Motors {
      TalonFXConfig TURRET_CONFIG =
          new TalonFXConfig()
              ...
              .withStatorCurrentLimitEnabled(false)
              .withRampRate(0.0)
              .withPIDConstants(Gains.slot0.kP, Gains.slot0.kI, Gains.slot0.kD, 0)
              .withFFConstants(Gains.slot0.kS, Gains.slot0.kV, Gains.slot0.kA, 0)
              .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign, 0)
              .withPIDConstants(0, 0, 10.0, 2)
              .withFFConstants(Gains.slot0.kS, Gains.slot0.kV, Gains.slot0.kA, 2)
              .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign, 2)
              .withPIDConstants(Gains.slot1.kP.get(), Gains.slot1.kI.get(), Gains.slot1.kD.get(), 1)
              .withFFConstants(Gains.slot1.kS.get(), Gains.slot1.kV.get(), Gains.slot1.kA.get(), 1)
    ...
    public interface Gains {
      ...
      public interface slot1 {
        LoggedNetworkNumber kP =
            new LoggedNetworkNumber("Superstructure/Turret/Gains/kP", 150.0); // 80
        LoggedNetworkNumber kI = new LoggedNetworkNumber("Superstructure/Turret/Gains/kI", 0.0);
        LoggedNetworkNumber kD =
            new LoggedNetworkNumber("Superstructure/Turret/Gains/kD", 3.0); // 10
