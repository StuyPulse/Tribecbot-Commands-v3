...
public class IntakeIOTalonFX implements IntakeIO {
    ...
    public IntakeIOTalonFX() {
        pivotMotor = new TalonFX(Ports.Intake.PIVOT, Ports.RIO);
        rollerLeaderMotor = new TalonFX(Ports.Intake.ROLLER_LEADER, Ports.RIO);
        rollerFollowerMotor = new TalonFX(Ports.Intake.ROLLER_FOLLOWER, Ports.RIO);
        ...
        pivotMotor.setPosition(Settings.Intake.PIVOT_STOW_ANGLE);
