...
public interface Settings {
    ...
    public interface Superstructure {
        ...
        public interface Hood {
            /**
             * DISCLAIMER: THERE IS NO ABS ENCODER ON THE BOT RN The absolute encoder is
             * mounted on a 11:1
             * gear reduction relative to the hood mechanism. This means:
             *
             * <p>
             * - The encoder rotates 11 times for every 1 full rotation of the hood. - The
             * hood's
             * physical range of motion is only 30 degrees.
             *
             * <p>
             * Because 30° * 11 = 330°, the encoder will never exceed 360° over the entire
             * hood travel.
             * Therefore, the absolute encoder reading (0–330°) uniquely maps to the hood’s
             * 0–30°
