...
public class TalonFXConfig {
   ...
   *
   * @param filterTime The configurable time constant in seconds of the Kalman velocity filter.
   ...
   *
   * @param currentLowerLimit The amount of supply current in amperes allowed after the regular
   *     {@link CurrentLimitsConfigs#SupplyCurrentLimit} is active for longer than the time
   *     parameter.
   ...
   *     CurrentLimitsConfigs#SupplyCurrentLimit} is active for longer than the time parameter.
   * @param time The amount of time that the regular {@link CurrentLimitsConfigs#SupplyCurrentLimit}
   *     can be active before lowring it to the currentLowerLimit parameter.
   * @return
   */
  ...
  /**
   * Modifies this configuration's torque current limits. Limits apply during torque current control
   * modes.
   *
   ...
   * @param neutralTolerance Current range in amperes where requested torque current will result in
   *     zero bridge output.
   * @return Itself for easier method-chaining.
   */
   ...
   * @param neutralTolerance Current range where requested torque current will result in zero bridge
   *     output.
   * @return Itself for easier method-chaining.
   */
  public TalonFXConfig withTorqueCurrentLimits(
   ...
   * @return Itself for easier method chaining.
   */
  public TalonFXConfig withVoltageLimits(Voltage peakForwardVoltage, Voltage peakReverseVoltage) {
   ...
   *
   * @param forwardEnable Whether to set the motor output to neutral if its position exceeds the
   *     forward threshold.
   * @param reverseEnable Whether to set the motor output to neutral if its position exceeds the
   *     reverse threshold.
   * @param forwardThreshold The threshold angle in rotations for the application of the forward
   *     limit.
   * @param reverseThreshold The threshold angle in rotations for the application of the reverse
   *     limit.
   * @return Itself for easier method-chaining.
   */
